...
import { X, ArrowDownUp, TrendingUp, TrendingDown, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
...
export const TradeModal = ({ coin, onClose }: TradeModalProps) => {
  ...
  const { buy, sell, portfolio } = usePortfolio();
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div
        className="bg-[#151619] border border-[#1A1B1E] rounded-2xl w-full max-w-md mx-4 shadow-2xl"
            ...
            <div className="bg-[#1A1B1E] rounded-xl p-4 border border-[#2A2B2E] space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white font-mono">
                  {parsedAmount} {coin.symbol.toUpperCase()}
                </span>
              </div>
              <div className="flex justify-between text-sm">
